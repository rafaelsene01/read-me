...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            library_commands::open_library_folder,
            reader_commands::process_book,
            reader_commands::cancel_processing,
            reader_commands::start_reading,
            reader_commands::open_reading,
            ...
            reader_commands::get_book_cover,
