...
| ILLUS-07 | P1: Comando que serve os bytes da imagem, com o caminho confinado ao livro | `reader_commands.rs` — `get_book_image` | implemented — unit do guarda de nome; o comando em si não é exercitado |
